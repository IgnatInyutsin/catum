main.controller('order_game_guide', function ($scope, $http, $location, $cookies, $routeParams) {
    //контроллер страницы order_game_guide
    $scope.$parent.pageName = 'order_game_guide';
    //подключение Api
    let api = new Api();
